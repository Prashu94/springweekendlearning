package io.spring.learning.example.aspect;
...
public class LoggerAspect {
    ...
    @Around("execution(* io.spring.learning.example..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* io.spring.learning.example.*.*(..))", throwing = "ex")
